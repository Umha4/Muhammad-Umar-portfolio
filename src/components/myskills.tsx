...
<>
<main className='max-w-screen-2xl mx-auto lg:h-[35rem] md:h-[40rem] h-[30rem] bg-gradient-to-r from-blue-100 via-blue-200  to-black  w-full'>
  <hr />
  ...
  <div className='flex flex-wrap lg:mt-16 md:mt-20 sm:mt-15 mt-6 mx-4 items-center justify-evenly'>
  ...
  <div className='flex flex-wrap mx-8 items-center justify-evenly  lg:font-bold font-semibold  md:text-2xl mt-4'>
