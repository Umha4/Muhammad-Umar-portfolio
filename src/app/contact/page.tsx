...
const Contact = () => {
  ...
  return (
    <>
   <main className='max-w-screen-2xl mx-auto bg-gradient-to-r from-blue-100 via-blue-200  to-black min-h-[800px] h-auto'>
  <hr />
      ...
      <section className='contact form'>
        <form onSubmit={onSubmit}>
          ...
          <div className='text-center pt-8 '>
            <button className='w-[50%] md:w-[23%] text-center text-white font-bold bg-black hover:bg-pink-700 h-[55px] border-2 rounded-2xl hover:transition hover:duration-700 hover:ease-in-out' type='submit'>Send Message</button>
          </div>
        </form>
      </section>
    </div>
