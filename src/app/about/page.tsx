...
const About = () => {
  return (
    <>
  <main className='max-w-screen-2xl mx-auto bg-gradient-to-r from-blue-100 via-blue-200  to-gray-900 h-auto min-h-[100vh]  flex flex-col md:flex-row font-sans pt-6'>
    {/* left div */}
    ...
    <div className='w-full md:w-[60%] pt-20 pl-6 md:pl-10'>
      <p className='font-extrabold text-black text-[20px] md:text-[22px] mt-2 md:mt-3 lg:mt-4'>ABOUT ME</p>
